...
function program8(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "\n        , <span style=\"font-variant: small-caps\">версия api</span>: ";
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n</div>\n<div class='container' id='resources_container'>\n    <ul id='resources'>\n    </ul>\n\n    <div class=\"footer\">\n        <br>\n        <br>\n        <h4 style=\"color: #999\">[ <span style=\"font-variant: small-caps\">базовый url</span>: ";
...
function program10(depth0,data) {
  ...
  return "\n        <div class='access'>\n          <span class=\"api-ic ic-off\" title=\"нажмите для аутентификации\"></span>\n        </div>\n        ";
  }
...
function program13(depth0,data) {
  ...
  buffer += escapeExpression(stack1)
    + "' placeholder='(обязательно)' type='text' value='";
  if (stack1 = helpers.defaultValue) { stack1 = stack1.call(depth0, {hash:{},data:data}); }
  else { stack1 = depth0.defaultValue; stack1 = typeof stack1 === functionType ? stack1.apply(depth0) : stack1; }
  buffer += escapeExpression(stack1)
    + "'/>\n			";
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div>\n<ul class=\"signature-nav\">\n    <li><a class=\"description-link\" href=\"#\">Модель</a></li>\n    <li><a class=\"snippet-link\" href=\"#\">Схема модели</a></li>\n</ul>\n</div>\n\n<div class=\"signature-container\">\n    <div class=\"description\">\n        ";
...
(function() {
  ...
  SwaggerUi = (function(_super) {
    ...
    SwaggerUi.prototype.render = function() {
      var _this = this;
      this.showMessage('Ресурсы загружены. Рендер Swagger UI...');
  ...
  MainView = (function(_super) {
    ...
    MainView.prototype.initialize = function(opts) {
      var route, sorter, sorterName, _i, _len, _ref;
      if (opts == null) {
        opts = {};
      }
  ...
  SignatureView = (function(_super) {
    ...
    SignatureView.prototype.render = function() {
      ...
      if (this.isParam) {
        $('.notice', $(this.el)).text('Нажмите, чтобы скопировать в параметр');
      }
      return this;
    };
  ...
  ContentTypeView = (function(_super) {
    ...
    ContentTypeView.prototype.render = function() {
      ...
      template = this.template();
      $(this.el).html(template(this.model));
      $('label[for=contentType]', $(this.el)).text('Content Type ответа');
      return this;
    };
  ...
  ResponseContentTypeView = (function(_super) {
    ...
    ResponseContentTypeView.prototype.render = function() {
      ...
      template = this.template();
      $(this.el).html(template(this.model));
      $('label[for=responseContentType]', $(this.el)).text('Content Type ответа');
      return this;
    };
  ...
  ParameterContentTypeView = (function(_super) {
    ...
    ParameterContentTypeView.prototype.render = function() {
      ...
      template = this.template();
      $(this.el).html(template(this.model));
      $('label[for=parameterContentType]', $(this.el)).text('Сontent type параметра:');
      return this;
    };
